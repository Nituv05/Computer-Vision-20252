...
\usepackage{iftex}
\ifpdftex
	\usepackage[utf8]{vietnam} % pdfLaTeX: Vietnamese support
\else
...
\begin{frame}{Visualizing Robustness via Saliency Maps}
	...
	\begin{figure}
		...
		\begin{minipage}{0.48\linewidth}
			\centering
			\includegraphics[width=\linewidth]{photos/Nico.png}
		\end{minipage}
		\hfill
		\begin{minipage}{0.48\linewidth}
			\centering
		...
		\caption{Saliency maps comparison on the NICO and PACS datasets.}
	\end{figure}
\end{frame}
