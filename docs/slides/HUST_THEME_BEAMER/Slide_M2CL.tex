	...
	\begin{frame}{Team Roles}
		\begin{columns}[T]
			\begin{column}{0.33\textwidth}
				\begin{block}{Vu Thuong Tin}
					\textbf{Baseline \& Problem Setting}
					\begin{itemize}
						\small
						\item DG problem structure
						\item Train/test pipeline
						\item ERM baseline
						\item Dataset loading \& domain split
						\item Why ERM fails
					\end{itemize}
				\end{block}
			\end{column}
			\begin{column}{0.33\textwidth}
				\begin{block}{Chu Anh Duc}
					\textbf{Core Model}
					\begin{itemize}
						\small
						\item $M^2$ architecture
						\item Extraction block
						\item Spatial Dropout
						\item Multi-scale pooling
						\item Projection head
					\end{itemize}
				\end{block}
			\end{column}
			\begin{column}{0.33\textwidth}
				\begin{block}{Nguyen Xuan Khai}
					\textbf{Loss \& Experiments}
					\begin{itemize}
						\small
						\item Contrastive loss
						\item Hyperparameters ($\alpha$, $\tau$)
...
\begin{frame}{Causal vs. Style Attribute Disentanglement}
		\begin{columns}[T]
			...
			\begin{column}{0.55\textwidth}
				\centering
				\vspace{0.1cm}
				\includegraphics[width=\linewidth]{photos/style.png}
				\usebeamercolor[fg]{caption}\small 
