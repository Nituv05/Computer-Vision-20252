...
ARCHITECTURE_SPECS = [
    ...
    ArchitectureSpec(
        tag="m2_cascading_r2_dropout",
        cls_name="M2CascadingR2Dropout",
        method="m2",
        description="M2 cascading concentration pipeline, r=2, spatial dropout",
        pipeline_type="cascading",
        reduction_ratio=2,
        dropout_p=0.3,
    ),
    ArchitectureSpec(
        tag="m2_cascading_r4_dropout",
        cls_name="M2CascadingR4Dropout",
        method="m2",
        description="M2 cascading concentration pipeline, r=4, spatial dropout",
        pipeline_type="cascading",
        reduction_ratio=4,
        dropout_p=0.3,
    ),
    ArchitectureSpec(
        tag="m2_cascading_r6_dropout",
        cls_name="M2CascadingR6Dropout",
        method="m2",
        description="M2 cascading concentration pipeline, r=6, spatial dropout",
        pipeline_type="cascading",
        reduction_ratio=6,
        dropout_p=0.3,
    ),
